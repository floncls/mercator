    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.application-blocks.update", [$applicationBlock->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maturity') ? 'is-invalid' : '' }}" type="number" min="0" max="5" name="maturity" id="maturity" value="{{ old('maturity', $applicationBlock->maturity) }}" required>
