    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.networks.update", [$network->id]) }}" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td  width="120">
                                    <select class="form-control select2 risk {{ $errors->has('security_need_c') ? 'is-invalid' : '' }}" name="security_need_c" id="security_need_c">
                                        <option class="" value="0" {{ ($network->security_need_c ? $network->security_need_c : old('security_need_c')) == 0 ? 'selected' : '' }}></option>
                                        <option class="white" value="1" {{ ($network->security_need_c ? $network->security_need_c : old('security_need_c')) == 1 ? 'selected' : '' }}>{{ trans('global.low') }}</option>
                                        <option class="yellow" value="2" {{ ($network->security_need_c ? $network->security_need_c : old('security_need_c')) == 2 ? 'selected' : '' }}>{{ trans('global.medium') }}</option>
                                        <option class="orange" value="3" {{ ($network->security_need_c ? $network->security_need_c : old('security_need_c')) == 3 ? 'selected' : '' }}>{{ trans('global.strong') }}</option>
                                        <option style="background-color: green;" value="4" {{ ($network->security_need_c ? $network->security_need_c : old('security_need_c')) == 4 ? 'selected' : '' }}>{{ trans('global.very_strong') }}</option>
                                    </select>
                                </td>
                                <td align="right">
                                ...
                                <td  width="120">
                                    <select class="form-control select2 risk {{ $errors->has('security_need_i') ? 'is-invalid' : '' }}" name="security_need_i" id="security_need_i">
                                        <option value="0" {{ ($network->security_need_i ? $network->security_need_i : old('security_need_i')) == 0 ? 'selected' : '' }}></option>
                                ...
                                <td  width="120">
                                    <select class="form-control select2 risk {{ $errors->has('security_need_a') ? 'is-invalid' : '' }}" name="security_need_a" id="security_need_a">
                                        <option value="0" {{ ($network->security_need_a ? $network->security_need_a : old('security_need_a')) == 0 ? 'selected' : '' }}></option>
                                ...
                                <td  width="120">
                                    <select class="form-control select2 risk{{ $errors->has('security_need_c') ? 'is-invalid' : '' }}" name="security_need_t" id="security_need_t">
                                        <option value="0" {{ ($network->security_need_t ? $network->security_need_t : old('security_need_t')) == 0 ? 'selected' : '' }}></option>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maturity') ? 'is-invalid' : '' }}" type="number" min="0" max="5" name="maturity" id="maturity" value="{{ old('maturity', $network->maturity) }}" required>
