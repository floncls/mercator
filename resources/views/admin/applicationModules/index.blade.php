...
@can('application_module_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.application-modules.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ApplicationModule">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <tr data-entry-id="{{ $applicationModule->id }}">
                            ...
                            <td>
                                @can('application_module_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.application-modules.show', $applicationModule->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('application_module_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.application-modules.edit', $applicationModule->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
