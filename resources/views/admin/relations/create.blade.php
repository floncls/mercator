    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.relations.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        <label class="recommended" for="name">{{ trans('cruds.relation.fields.reference') }}</label>
                        <input type="text" class="form-control" id="reference" name="reference" min="0" value="{{ old('reference') }}">
                ...
                <div class="col-sm">
                    <div class="form-group">
                        <label class="recommended" for="name">{{ trans('cruds.relation.fields.order_number') }}</label>
                        <input type="text" class="form-control" id="order_number" name="order_number" min="0" value="{{ old('order_number') }}">
