    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.gateways.update", [$gateway->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maturity') ? 'is-invalid' : '' }}" type="number" min="0" max="5" name="maturity" id="maturity" value="{{ old('maturity', $gateway->maturity) }}" required>
