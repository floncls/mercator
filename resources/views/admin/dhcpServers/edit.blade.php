    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dhcp-servers.update", [$dhcpServer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maturity') ? 'is-invalid' : '' }}" type="number" min="0" max="5" name="maturity" id="maturity" value="{{ old('maturity', $dhcpServer->maturity) }}" required>
